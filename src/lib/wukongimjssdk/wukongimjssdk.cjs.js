...
var curve25519Js = require('curve25519-js');
...
var Encoder = /** @class */ (function () {
    function Encoder() {
        this.w = new Array();
        this.d32 = new BigNumber__default["default"](4294967296);
    }
...
var Decoder = /** @class */ (function () {
    ...
    Decoder.prototype.readNum = function (b) {
        ...
        this.offset += b;
        var n = new BigNumber__default["default"](0);
        for (var i = 0; i < data.length; i++) {
            var d = new BigNumber__default["default"](2).pow(new BigNumber__default["default"]((data.length - i - 1) * 8));
            n = n.plus(new BigNumber__default["default"](data[i]).multipliedBy(d));
        }
        return n;
    };
...
var SecurityManager = /** @class */ (function () {
    ...
    SecurityManager.prototype.encryption = function (message) {
        var actMsgKeyBytes = CryptoJS__default["default"].AES.encrypt(CryptoJS__default["default"].enc.Utf8.parse(message), CryptoJS__default["default"].enc.Utf8.parse(this.aesKey), {
            keySize: 128 / 8,
            iv: CryptoJS__default["default"].enc.Utf8.parse(this.aesIV),
    ...
    SecurityManager.prototype.decryption = function (message) {
        ...
        var messagedecBase64 = CryptoJS__default["default"].enc.Base64.parse(messageStr);
        var decrypted = CryptoJS__default["default"].AES.decrypt(CryptoJS__default["default"].enc.Base64.stringify(messagedecBase64), CryptoJS__default["default"].enc.Utf8.parse(this.aesKey), {
            keySize: 128 / 8,
            iv: CryptoJS__default["default"].enc.Utf8.parse(this.aesIV),
            mode: CryptoJS__default["default"].mode.CBC,
            padding: CryptoJS__default["default"].pad.Pkcs7
        });
        return Uint8Array.from(buffer__namespace.Buffer.from(decrypted.toString(CryptoJS__default["default"].enc.Utf8)));
    };
...
var Proto = /** @class */ (function () {
    ...
    Proto.prototype.encodeConnect = function (packet) {
        ...
        enc.writeInt64(new BigNumber__default["default"](packet.clientTimestamp));
    ...
    Proto.prototype.encodeSend = function (packet) {
        ...
        enc.writeString(md5Typescript.Md5.init(msgKey));
        // topic
    ...
    Proto.prototype.encodeRecvack = function (packet) {
        var enc = new Encoder();
        enc.writeInt64(new BigNumber__default["default"](packet.messageID));
...
var ConnectManager = /** @class */ (function () {
    ...
    ConnectManager.prototype.connectWithAddr = function (addr) {
        ...
        this.ws.onopen(function () {
            ...
            var keyPair = curve25519Js.generateKeyPair(seed);
    ...
    ConnectManager.prototype.onPacket = function (data) {
        ...
        if (p.packetType === exports.PacketType.CONNACK) {
            ...
            if (connackPacket.reasonCode === 1) {
                ...
                var secret = curve25519Js.sharedKey(this.dhPrivateKey, serverPubKey);
                var secretBase64 = buffer__namespace.Buffer.from(secret).toString("base64");
                var aesKeyFull = md5Typescript.Md5.init(secretBase64);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (packet instanceof RecvPacket) {
                    ...
                    actMsgKeyMD5 = md5Typescript.Md5.init(actMsgKey);
